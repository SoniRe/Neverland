...
function split() {
  ...
  document
    .querySelector("#page1 h2")
    .textContent.split("")
    .forEach((letter) => {
      clutter2 += `<span>${letter}</span>`;
    });

  document.querySelector("#page1 h2").innerHTML = clutter2;
}
...
function split3() {
  ...
  document
    .querySelector("#page7 h2")
    .textContent.split("")
    .forEach((elem) => {
      clutter += `<span>${elem}</span>`;
    });

  document.querySelector("#page7 h2").innerHTML = clutter;
}
...
gsap.to("#page1 h1 span", {
  ...
  scrollTrigger: {
    ...
    scroller: "#main",
    scrub: 3,
    start: "top 20%", // meaning top of the trigger element meets 30% of viewport
    end: "top 10%", // meaning top of trigger element meets 0% of viewport
  },
});
...
gsap.to("#page1 h2 span", {
  ...
  scrollTrigger: {
    ...
    scroller: "#main",
    scrub: 3,
    start: "top 0%", // meaning top of the trigger element meets 5% of viewport
    end: "top -20%",
  },
});
